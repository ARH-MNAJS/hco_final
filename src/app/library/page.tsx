...
export default function Home() {
  return (
    <div className="mt-[10svh] text-text dark:text-darkText relative mx-auto h-full w-[700px] max-w-full p-8 md:p-16 xl:w-[1400px]">
      <div className="mb-12 w-full xl:fixed xl:mb-0 xl:w-[500px]">
        ...
        <div className="mt-8">
          <h2 className="text-3xl font-heading sm:text-[44px]">Hawking Library</h2>
          <p className="mt-6 text-base font-base sm:text-xl">
            Explore a curated collection of topics for the Hawking Code Olympiad.
            Dive deep into coding challenges and enhance your skills.
          </p>
          <button className="mt-6 border-border dark:border-darkBorder shadow-light dark:shadow-dark rounded-base border-2 bg-main p-3 font-heading transition-all hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none dark:hover:shadow-none">
            Contribute
          </button>
        </div>
      </div>
